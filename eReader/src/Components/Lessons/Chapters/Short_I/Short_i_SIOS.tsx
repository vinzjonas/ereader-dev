...
import shortIvid from '../../../Videos/Short Vowel (E).mp4'

const Short_i_SIOS = ({setCurrentPage}) => {
    const test = ['1', '2'];
    return (
        <ThemeProvider breakpoints={['xxxl', 'xxl', 'xl', 'lg', 'md', 'sm', 'xs', 'xxs']} minBreakpoint="xxs">
            <Container fluid="sm" style={{padding: '20px'}}>
                ...
                <Row style={{paddingTop: '20px'}}>
                    <Col>
                    <Button variant="secondary" onClick={() => setCurrentPage("Short_i")} size="lg"> Go Back </Button>
                    </Col>
