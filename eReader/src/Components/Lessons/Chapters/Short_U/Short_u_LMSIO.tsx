...
const Short_u_LMSIO = ({setCurrentPage}) => {
    const test = ['1', '2'];
    return (
        <ThemeProvider breakpoints={['xxxl', 'xxl', 'xl', 'lg', 'md', 'sm', 'xs', 'xxs']} minBreakpoint="xxs">
            <Container fluid="sm" style={{padding: '20px'}}>
                ...
                <Row style={{paddingTop: '20px', paddingBottom: '20px'}}>
                    <Col>
                    <Button variant="secondary" style={{}} onClick={() => setCurrentPage("Short_u")} size="lg"> Go Back </Button>
                    </Col>
                </Row>
            </Container>
        </ThemeProvider>
